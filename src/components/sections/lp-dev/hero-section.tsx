      ...
      <Container section={true} className="z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="#registrar"
              className="py-4 px-2 md:px-6 rounded-full flex items-center justify-start relative overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed bg-[#f47834] text-white font-medium hover:bg-[#e06724] transition-colors"
            >
              Registrar Minha Marca
            </Link>
            <Link
              href="#consultoria"
              className="py-4 px-2 md:px-6 rounded-full flex items-center justify-start relative overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed bg-white text-[#f47834] border-2 border-[#f47834] font-medium hover:bg-gray-50 transition-colors"
            >
