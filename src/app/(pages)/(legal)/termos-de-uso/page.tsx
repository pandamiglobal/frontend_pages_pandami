    ...
    return (
        <Container>
            <div className="container flex flex-col gap-3 p-4">
                ...
                <p>
                    Bem-vindo ao site <a href="http://www.pppi.com.br">www.pppi.com.br</a>, de titularidade da PPPI Serviços Administrativos LTDA (CNPJ: 41.491.976/0001-91).
                    ...
                    A PPPI se reserva o direito de alterar estes termos a qualquer momento, sendo responsabilidade do usuário revisá-los periodicamente para estar ciente de quaisquer modificações.
                </p>

                <h4 className="wp-block-heading"><strong>1.2. Definições</strong></h4>
                <p>Para fins destes Termos de Uso, considera-se:</p>
                <ul className="wp-block-list">
                    <li><strong>PPPI</strong>: PPPI Serviços Administrativos LTDA.</li>
                    <li><strong>Usuário</strong>: Toda pessoa que acessar ou utilizar o site <a href="http://www.pppi.com.br">www.pppi.com.br</a>.</li>
                    <li><strong>Site</strong>: O conjunto de páginas e funcionalidades acessíveis pelo domínio <a href="http://www.pppi.com.br">www.pppi.com.br</a>.</li>
                </ul>
                ...
                <ul className="wp-block-list">
                    ...
                    <li>Não praticar atos que comprometam a segurança do site ou que possam causar prejuízos à PPPI ou a terceiros;</li>
                ...
                <h4 className="wp-block-heading"><strong>3.3. Direitos da PPPI</strong></h4>
                <p>A PPPI reserva-se o direito de, a qualquer momento e sem aviso prévio:</p>
                <ul className="wp-block-list">
                ...
                <p>
                    ...
                    ícones, software e quaisquer outras informações, é de propriedade exclusiva da PPPI ou de seus licenciadores, estando
                    protegido por leis de propriedade intelectual. É vedada a reprodução, modificação, distribuição, transmissão, publicação
                    ou qualquer outra forma de utilização do conteúdo sem a prévia e expressa autorização por escrito da PPPI.
                </p>
                ...
                <p>
                    ...
                    declara que detém todos os direitos necessários sobre o conteúdo submetido e concede à PPPI uma licença irrevogável,
                ...
                <p>
                    A PPPI coleta e utiliza informações pessoais dos Usuários conforme descrito na nossa Política de Privacidade.
                ...
                <p>
                    ...
                    direitos, o Usuário deve entrar em contato com a PPPI através do e-mail lgpd@pppi.com.br. A PPPI se compromete a
                ...
                <p>
                    ...
                    de garantia, expressa ou implícita. A PPPI não garante que o site estará disponível de forma ininterrupta ou livre de
                    erros, nem que eventuais defeitos serão corrigidos. A PPPI não garante que o site ou seu conteúdo atendam às
                    necessidades ou expectativas do Usuário.
                </p>

                <h4 className="wp-block-heading"><strong>6.2. Limitação de Danos</strong></h4>
                <p>
                    Em nenhuma hipótese a PPPI será responsável por quaisquer danos diretos, indiretos, incidentais, especiais,
                    consequenciais ou punitivos, incluindo, mas não se limitando a, perda de lucros, perda de dados, ou outros prejuízos
                    resultantes do uso ou da impossibilidade de uso do site, mesmo que a PPPI tenha sido previamente avisada da
                    possibilidade de tais danos. A responsabilidade da PPPI por quaisquer danos decorrentes ou relacionados a este site
                ...
                <p>
                    A PPPI reserva-se o direito de modificar, alterar ou atualizar estes Termos de Uso a qualquer momento, sem aviso
                ...
                <p>Para questões relacionadas à proteção de dados pessoais, o contato deve ser feito através do e-mail lgpd@pppi.com.br.</p>
                ...
                <p>
                    ...
                    através do e-mail contato@pppi.com.br.
                </p>
                ...
                <p>
                    A PPPI oferece serviços de consultoria administrativa, registro de marcas e patentes, e outros serviços relacionados à
                    propriedade intelectual(Saas e I.A). A descrição detalhada dos serviços oferecidos pode ser encontrada nas páginas
                    específicas do site. A PPPI reserva-se o direito de modificar, suspender ou descontinuar qualquer um dos serviços
                    oferecidos, a qualquer momento e sem aviso prévio, sem que isso implique qualquer responsabilidade para a PPPI.
                </p>

                <h4 className="wp-block-heading"><strong>10.2. Condições de Pagamento</strong></h4>
                <p>
                    Os serviços prestados pela PPPI podem estar sujeitos a taxas e pagamentos específicos, conforme detalhado nas páginas
                    relevantes do site ou em contratos específicos firmados entre a PPPI e o Usuário. O Usuário concorda em pagar todas
                    as taxas aplicáveis pelos serviços contratados, de acordo com as condições de pagamento estabelecidas pela PPPI.
                </p>
                ...
                <p>
                    A PPPI pode, ocasionalmente, enviar mensagens promocionais ou de publicidade para os Usuários cadastrados. Os Usuários
                ...
                <p>
                    Qualquer feedback ou sugestão fornecida pelo Usuário à PPPI será considerado não-confidencial e não-proprietário.
                    A PPPI terá o direito de usar tais feedbacks e sugestões sem restrições, para quaisquer fins, incluindo, mas não se
                ...
                <p>
                    Estes Termos de Uso constituem o acordo integral entre o Usuário e a PPPI em relação ao uso do site e dos serviços
                    oferecidos. Qualquer modificação ou alteração destes Termos de Uso deverá ser feita por escrito e assinada por um
                    representante autorizado da PPPI.
                </p>

                <h4 className="wp-block-heading"><strong>12.2. Renúncia</strong></h4>
                <p>
                    A falha da PPPI em exigir o cumprimento de qualquer disposição destes Termos de Uso não constituirá uma renúncia ao
                    direito de exigir tal cumprimento em qualquer momento futuro. A renúncia a qualquer disposição destes Termos de Uso
                    só será efetiva se for feita por escrito e assinada por um representante autorizado da PPPI.
                </p>
                ...
                <p>
                    ...
                    relação aos seus dados pessoais, o Usuário pode entrar em contato com a PPPI através dos seguintes meios:
                </p>
                <ul className="wp-block-list">
                    <li><strong>E-mail:</strong> contato@pppi.com.br</li>
                </ul>
                ...
                <p>
                    ...
                    reembolso devem ser feitos por escrito e enviados para contato@pppi.com.br.
                </p>
                ...
                <p>
                    ...
                    descritos nos contratos específicos. A PPPI se reserva o direito de cobrar taxas de cancelamento conforme especificado
                ...
                <p>
                    ...
                    em tentar resolver a questão amigavelmente, através de negociação direta com a PPPI.
                </p>
                ...
                <p>
                    A PPPI se reserva o direito de atualizar estes Termos de Uso periodicamente, para refletir mudanças nos serviços, nas
                ...
                <p>
                    Estes Termos de Uso, juntamente com a Política de Privacidade e quaisquer outros termos fornecidos pela PPPI em
                    relação a serviços específicos, constituem o acordo completo entre o Usuário e a PPPI em relação ao uso do site e dos
                    serviços oferecidos.
                </p>
            </div>
        </Container>
